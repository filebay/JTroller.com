...
<head>
    ...
    <title>JTroller.com Game - Mobile</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="mt-3">Currently Available on Desktop Only</h2>
        <p>Our Justin Trudeau log rolling game is currently only playable on desktop devices. Please visit us on a desktop to enjoy the game!</p>
